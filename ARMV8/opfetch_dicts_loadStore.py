...
def LOAD_STORE_REGISTER_POSTINDEXED_IMMEDIATE(binary):
    ...
    return {       
       ...
       "00111000010"+"-"*9+"01" : opfetch_loadStore.opfetchLDRB_reg_posti,
       "01111000010"+"-"*9+"01" : opfetch_loadStore.opfetchLDRH_reg_posti,
       "00111000110"+"-"*9+"01" : opfetch_loadStore.opfetchLDRSB_reg_posti_32,
       "00111000100"+"-"*9+"01" : opfetch_loadStore.opfetchLDRSB_reg_posti_64,
    }[key](binary)
...
def LOAD_STORE_REGISTER_PREINDEXED_IMMEDIATE(binary):
    ...
    return {       
       ...
       "00111000010"+"-"*9+"11" : opfetch_loadStore.opfetchLDRB_reg_prei,
       "01111000010"+"-"*9+"11" : opfetch_loadStore.opfetchLDRH_reg_prei,
       "00111000110"+"-"*9+"11" : opfetch_loadStore.opfetchLDRSB_reg_prei_32,
       "00111000100"+"-"*9+"11" : opfetch_loadStore.opfetchLDRSB_reg_prei_64,
    }[key](binary)
...
def LOAD_STORE_REGISTER_UNSIGNED_OFFSET(binary):
    ...
    return {       
       ...
       "0011100101" : opfetch_loadStore.opfetchLDRB_reg_unsignedOffset,
       "0111100101" : opfetch_loadStore.opfetchLDRH_reg_unsignedOffset,
       "0011100111" : opfetch_loadStore.opfetchLDRSB_reg_unsignedOffset_32,
       "0011100110" : opfetch_loadStore.opfetchLDRSB_reg_unsignedOffset_64,
    }[key](binary)
...
def LOAD_STORE_REGISTER_OFFSET(binary):
    ...
    return {       
       ...
       "00111000011"+"-"*9+"10" : opfetch_loadStore.opfetchLDRB_reg_offset,
       "01111000011"+"-"*9+"10" : opfetch_loadStore.opfetchLDRH_reg_offset,
       "00111000111"+"-"*9+"10" : opfetch_loadStore.opfetchLDRSB_reg_offset_32,
       "00111000101"+"-"*9+"10" : opfetch_loadStore.opfetchLDRSB_reg_offset_64,
    }[key](binary)
